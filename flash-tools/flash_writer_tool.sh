...
if [ "$BOARD" == "rzv2h-evk-ver1" ] || [ "$BOARD" == "rzv2n-evk" ]; then
    ...
    SPI_SA0_RAM=""      ; SPI_SA0_FLASH="" 
    SPI_BL2_RAM="8101E00" ; SPI_BL2_FLASH="0"
    SPI_SA6_RAM=""      ; SPI_SA6_FLASH="" 
    SPI_BL31_RAM=""     ; SPI_BL31_FLASH="" 
    SPI_UBOOT_RAM=""    ; SPI_UBOOT_FLASH="" 
    SPI_FIP_RAM="0"     ; SPI_FIP_FLASH="60000"

    EMMC_SA0_RAM=""          ; EMMC_SA0_PART=""   ; EMMC_SA0_SECTOR=""   
    EMMC_BL2_RAM="8101E00"   ; EMMC_BL2_PART="1"  ; EMMC_BL2_SECTOR="1"
    EMMC_SA6_RAM=""          ; EMMC_SA6_PART=""   ; EMMC_SA6_SECTOR=""   
    EMMC_BL31_RAM=""         ; EMMC_BL31_PART=""  ; EMMC_BL31_SECTOR=""  
    EMMC_UBOOT_RAM=""        ; EMMC_UBOOT_PART="" ; EMMC_UBOOT_SECTOR="" 
