...
#define GPIO_PWPR_PFCWE_MSK     (0x00000040uL)          /* Mask bit pattern of PFCWE */
#define GPIO_PWPR_PFCWE_WDIS    (0x00000000uL)          /* Write-protect to PFC */
#define GPIO_PWPR_PFCWE_WEN     (0x00000040uL)          /* Write-enable to PFC */

#define GPIO_PWPR_OENWE_MSK     (0x00000020uL)          /* Mask bit pattern of OEN */
#define GPIO_PWPR_OENWE_WDIS    (0x00000000uL)          /* Write-protect to OEN */
#define GPIO_PWPR_OENWE_WEN     (0x00000020uL)          /* Write-enable to OEN */

/*** Define bit pattern of GPIO_OEN ***/
#define GPIO_OEN_XSPI0_ON       (0x00000000uL)          /* xSPI0_CKP/xSPI0_CKN/xSPI0_CS0_N/xSPI0_RESET0_N */
#define GPIO_OEN_XSPI0_OFF      (0x0000003CuL)          /* xSPI0_CKP/xSPI0_CKN/xSPI0_CS0_N/xSPI0_RESET0_N */
#define GPIO_OEN_XSPI0_MSK      (0x0000003CuL)          /* xSPI0_CKP/xSPI0_CKN/xSPI0_CS0_N/xSPI0_RESET0_N */
