...
/**********************************************************************************************************************
 Macro definitions
 *********************************************************************************************************************/
#define OSTM0CMP_0    ((volatile uint32_t *)( RZV2H_GTM0_BASE + 0x000 ))  /* OSTM compare register_0 */
#define OSTM0CNT_0    ((volatile uint32_t *)( RZV2H_GTM0_BASE + 0x004 ))  /* OSTM counter register_0 */
#define OSTM0TE_0     ((volatile uint8_t *) ( RZV2H_GTM0_BASE + 0x010 ))  /* OSTM count enable status register_0 */
#define OSTM0TS_0     ((volatile uint8_t *) ( RZV2H_GTM0_BASE + 0x014 ))  /* OSTM count start trigger register_0 */
#define OSTM0TT_0     ((volatile uint8_t *) ( RZV2H_GTM0_BASE + 0x018 ))  /* OSTM count stop trigger register_0 */
#define OSTM0CTL_0    ((volatile uint8_t *) ( RZV2H_GTM0_BASE + 0x020 ))  /* OSTM control register_0 */
